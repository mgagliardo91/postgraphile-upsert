...
const initializePostgraphile = async (t, options = {}) => {
    const middleware = (0, postgraphile_1.postgraphile)(t.context.client, "public", {
        graphiql: true,
    ...
    const serverPort = await (0, freeport_1.freeport)();
    t.context.serverPort = serverPort;
    t.context.server = (0, http_1.createServer)(middleware).listen(serverPort);
};
test.beforeEach(async (t) => {
    await db_1.container.setup(t.context);
    t.context.client = await await (0, p_retry_1.default)(async () => {
        const pool = await (0, client_1.createPool)(t.context.dbConfig);
...
const execGqlOp = (t, query) => (0, node_fetch_1.default)(`http://localhost:${t.context.serverPort}/graphql`, {
    body: query(),
    headers: {
